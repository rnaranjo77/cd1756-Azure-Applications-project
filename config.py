...
class Config(object):
    ...
    CLIENT_SECRET = os.environ.get("CLIENT_SECRET") or "B0y8Q~hR5ecQHB1kKU2h1k.EfA0CFb9LDcVWDbB0"
    ...
    CLIENT_ID = os.environ.get("CLIENT_ID") or "aed339d8-12a2-4964-be4e-d328d09dd4db"
